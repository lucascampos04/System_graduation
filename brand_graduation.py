...
from insertDataSchoolRepository import inserir_name_school, \
                                    inserir_name_curse, \
                                    inserir_select_date,\
                                    inserir_endereco
...
def selecionar_ende(event):
    ...
    inserir_endereco(adress_selecionado)

    # remove o endereço selecionada do combos
    label_ende_selecionada = Label(frame_midle, text=f"Endereço selecionada: {adress_selecionado}", font=("Arial 14 bold"), bg="blue")
...
def brand_graduation():
    ...
    label_select_ende = Label(frame_midle, text="Escolha um endereço", font=("Arial 14 bold"), bg="blue")
